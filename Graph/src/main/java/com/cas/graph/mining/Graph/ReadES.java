...
public class ReadES {
    ...
    public static void main( String[] args ) throws InterruptedException, IOException, ParseException, KeyManagementException, NoSuchAlgorithmException, KeyStoreException, NSQException, TimeoutException
    {
        ...
        HashMap<String, HashSet<String>> ipEdge = new HashMap<String ,HashSet<String>>();
	...
	public static void searchES(JestClient client, String startdate, String enddate, String indextype ,HashMap<String, HashMap<String, Integer>> ipNode,HashMap<String, HashSet<String>> ipEdge) throws IOException, ParseException {
		...
		while(true){
			...
			HashSet<String> edgeOfToday = new HashSet<String>();
            ...
            //continue;
    			...
    			/*System.out.println(indexname + "的节点数：" + nodeOfToday.size() + "边数是：" + edgeOfToday.size());*/
            	if(num == true){
	...
	//Read everyday's IP
	public static Boolean readIP(String resultJson, String date, HashMap<String, Integer> nodeOfToday, HashSet<String> edgeOfToday) {
		JsonParser parse =new JsonParser(); 
        JsonObject json=(JsonObject) parse.parse(resultJson);  
        JsonObject hits=json.get("hits").getAsJsonObject();
        JsonArray hits2=hits.get("hits").getAsJsonArray();
        String[] va = date.split("_");  // date (index_name)"jg_liuliang_20180726"
        ...
        for(int i=0;i<hits2.size();i++)
        {
            ...
            String transport = pro1 + pro2;
            /***Check whether over 500***/
            if(nodeOfToday.size() < 500){
            ...
            //System.out.println("*******From source: sip:" + sip +"sport:" + sport + "   To dest: dip:" + dip + "dport:" + dport + "******");
        }
	...
	public static void writeForGBAD(HashMap<String, HashMap<String, Integer>> ipNode, HashMap<String, HashSet<String>> ipEdge) throws IOException {
	...
	//Get ipNode and ipEdge, then write to graph.txt.
		public static void writeForFiveHun(HashMap<String, HashMap<String, Integer>> ipNode, HashMap<String, HashSet<String>> ipEdge) throws IOException {
			// TODO Auto-generated method stub
	 ...
	 public static void writeForMining(HashMap<String, HashMap<String, Integer>> ipNode,
            ...
            while(edges.hasNext()){
            	...
            	Integer snode = dayNode.get(sip);
            	Integer dnode = dayNode.get(dip);
            	//Check if there are the same dip:sip
            	String conIp = dip+":"+sip;
            	if(!dayEdge.contains(conIp)){
            		writer.write(String.valueOf(dnode) +" "+ String.valueOf(snode));
            		writer.newLine();
            	}
